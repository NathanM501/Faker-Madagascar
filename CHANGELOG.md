...
### Changed
- **Name generation**: `firstName()` and `lastName()` now return real Malagasy names from curated data sets (101 first names, 102 last names) instead of syllable combinations, producing more realistic and recognizable Malagasy names.
